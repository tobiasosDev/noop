...
private struct MetricRow: View {
    ...
    var body: some View {
        ...
        // Localized title/category (local) read out with the Imperial/Metric-aware unit
        // label (upstream), so VoiceOver matches both the locale and the unit preference.
        .accessibilityLabel("\(metric.localizedTitle), \(unitLabel.isEmpty ? metric.localizedCategory : unitLabel)\(isEmpty ? ", no data" : "")")
